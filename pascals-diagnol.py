...
# This solution leverages the fact that the lth value of the nth diagnol can be calculated 
# by taking the sum all values [0:l] in the (n-1) diagnol.
...
def generate_diagonal(n, l):
    ...
    for i in range(l): #first loop builds a list of all 1s
        diagnol.append(1)
    if n==0:                
        return diagnol[0:l]  #added an early return for the n=0 fringe case
